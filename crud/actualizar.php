...
<body>
  ...
  <div class="container">
    ...
    <p>Usted esta en la sección para actualizar o editar un registro</p>
    <br />
    ...
    <form action="./actualizar.php" method="post">
      ...
      <div class="input-group mb-3">
        <div class="form-floating mb-3">
          <button type="submit" class="btn btn-success" name="editar" id="editar"><i class="bi bi-pen"></i> Editar</button>
      ...
      if (isset($_POST["editar"])) {
        $sql = "SELECT * FROM paciente WHERE id != '" . $_POST["id_org"] . "' AND n_documento = '" . $_POST["n_doc"] . "' ";
        $respuesta = $conn->query($sql);
        //echo "Respuesta: ".$respuesta->num_rows;

        if ($respuesta->num_rows == 0) {
          $sql = " UPDATE paciente SET id= '" . $_POST["id"] . "', n_documento = '" . $_POST["n_doc"] . "', tipo_documento = '" . $_POST["t_doc"] . "', nombres = '" . $_POST["nom"] . "', 
                apellidos = '" . $_POST["apell"] . "', genero = '" . $_POST["genero"] . "', telefono = '" . $_POST["tel"] . "', correo = '" . $_POST["correo"] . "' 
                WHERE id = '" . $_POST["id_org"] . "'; ";
          $conn->query($sql);
        } else {
          echo '
            <script>
                Swal.fire({
                  icon: "error",
                  title: "Oops...",
                  text: "No puede cambiar el ID. Ya existe un paciente con ese numero de ID",
                });
            </script>
            ';
        }
